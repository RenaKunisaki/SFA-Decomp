...
const u16 dspMixerCycles[32] = {
    0x05BE, 0x0B7C, 0x0B7C, 0x113A, 0x08B6, 0x116C, 0x116C, 0x1A22,
    0x09A6, 0x134C, 0x134C, 0x1CF2, 0x0E97, 0x1D2E, 0x1D2E, 0x2BC5,
    0x0B7C, 0x0D3A, 0x0B7C, 0x0D3A, 0x0B7C, 0x0D3A, 0x0B7C, 0x0D3A,
    0x134C, 0x1637, 0x134C, 0x1637, 0x134C, 0x1637, 0x134C, 0x1637,
};

const u16 pbOffsets[12] = {
    0x000A, 0x000C, 0x0018, 0x000E, 0x0010, 0x001A, 0x0012, 0x0014, 0x0016, 0x0000, 0x0000, 0x0000,
};

const u8 sInpMidiCtrlFullResetPreset[136] = {
    0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x00, 0x7F, 0x00, 0x00, 0x40, 0x7F,
...
const u8 sInpMidiCtrlMaskedResetPreset[136] = {
    0xFF, 0x00, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0xFF, 0x7F,
...
const u16 gItdPanDelayTable[128] = {
    ...
    0x0007, 0x0008, 0x0008, 0x0008, 0x0009, 0x0009, 0x0009, 0x000A,
    0x000A, 0x000A, 0x000B, 0x000B, 0x000C, 0x000C, 0x000C, 0x000D,
    ...
    0x0019, 0x0019, 0x001A, 0x001A, 0x001A, 0x001B, 0x001B, 0x001B,
    0x001C, 0x001C, 0x001C, 0x001C, 0x001D, 0x001D, 0x001D, 0x001D,
    0x001D, 0x001E, 0x001E, 0x001E, 0x001E, 0x001E, 0x001F, 0x001F,
