...
extern const f32 GXIndTexMtxScale[2];
...
void GXSetIndTexMtx(GXIndTexMtxID mtx_id, const f32 offset[2][3], s8 scale_exp) {
    ...
    mtx[0][0] = (s32)(GXIndTexMtxScale[0] * offset[0][0]);
    mtx[1][0] = (s32)(GXIndTexMtxScale[0] * offset[1][0]);
    reg0 = mtx[0][0] & 0x7FF;
    ...
    mtx[0][1] = (s32)(GXIndTexMtxScale[0] * offset[0][1]);
    mtx[1][1] = (s32)(GXIndTexMtxScale[0] * offset[1][1]);
    reg1 = mtx[0][1] & 0x7FF;
    ...
    mtx[0][2] = (s32)(GXIndTexMtxScale[0] * offset[0][2]);
    mtx[1][2] = (s32)(GXIndTexMtxScale[0] * offset[1][2]);
    reg2 = mtx[0][2] & 0x7FF;
