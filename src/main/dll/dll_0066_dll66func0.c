...
void dll_66_func03(int sourceObj, int variant, int posSource, u32 flags)
{
    ...
    buf.entries[1].x = (*(f32*)&lbl_803E0994);
    buf.entries[1].y = (*(f32*)&lbl_803E0998);
    buf.entries[1].z = (*(f32*)&lbl_803E0994);
    buf.entries[2].layer = 0;
    buf.entries[2].flags = 0x50;
    buf.entries[2].tex = NULL;
    buf.entries[2].mode = 0x20000000;
    buf.entries[2].x = (*(f32*)&lbl_803E099C);
    buf.entries[2].y = (*(f32*)&lbl_803E09A0);
    buf.entries[2].z = (*(f32*)&lbl_803E09A4);
    buf.entries[3].layer = 0;
    buf.entries[3].flags = 0;
    buf.entries[3].tex = NULL;
    buf.entries[3].mode = 0x80000;
    buf.entries[3].x = lbl_803E0990;
    buf.entries[3].y = (*(f32*)&lbl_803E09A8);
    ...
    buf.entries[7].y = (*(f32*)&lbl_803E0998);
    ...
    buf.entries[11].y = (*(f32*)&lbl_803E0998);
    ...
    buf.entries[12].z = (*(f32*)&lbl_803E09BC);
    ...
    buf.entries[13].y = (*(f32*)&lbl_803E09C0);
    ...
    buf.entries[15].y = (*(f32*)&lbl_803E0998);
    ...
    buf.entries[16].z = (*(f32*)&lbl_803E09BC);
    buf.entries[17].layer = 3;
    buf.entries[17].flags = 0x15;
    buf.entries[17].tex = &base[432];
    buf.entries[17].mode = 2;
    buf.entries[17].x = (*(f32*)&lbl_803E0994);
    buf.entries[17].y = (*(f32*)&lbl_803E09B4);
    buf.entries[17].z = (*(f32*)&lbl_803E0994);
    ...
    buf.entries[18].y = (*(f32*)&lbl_803E09B0);
    buf.entries[18].z = lbl_803E0990;
    buf.entries[18].layer = 4;
    buf.entries[18].flags = 0;
    buf.entries[18].tex = NULL;
    buf.entries[18].mode = 0x20000000;
    buf.entries[18].x = (*(f32*)&lbl_803E099C);
    buf.entries[18].y = (*(f32*)&lbl_803E09A0);
    buf.entries[18].z = (*(f32*)&lbl_803E09A4);
    buf.v58 = 0;
    ctx = sourceObj;
    buf.ctx = ctx;
    buf.v44 = variant;
    ...
    if ((buf.flags & 1) != 0)
    {
        if ((void*)ctx != NULL)
        {
            buf.pos[0] = lbl_803E0990 + ((GameObject*)ctx)->anim.worldPosX;
            buf.pos[1] = lbl_803E0990 + ((GameObject*)ctx)->anim.worldPosY;
            buf.pos[2] = lbl_803E0990 + ((GameObject*)ctx)->anim.worldPosZ;
        }
        else
        {
