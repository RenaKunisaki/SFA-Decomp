...
extern ResourceDescriptor gDIM_trickyObjDescriptor, gDIMbosscrackparObjDescriptor, gDIMbossfireObjDescriptor,
    gDR_CloudRunnerObjDescriptor, gDR_EarthWarriorObjDescriptor;
