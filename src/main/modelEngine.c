...
extern ResourceDescriptor gDIM_BossSpitObjDescriptor, gDIM_trickyObjDescriptor, gDIMbosscrackparObjDescriptor,
    gDIMbossfireObjDescriptor, gDR_CloudRunnerObjDescriptor, gDR_EarthWarriorObjDescriptor;
