...
ObjectDescriptor4WithPadding dll_99_funcs = {
    {
        0,
        0,
        0,
        OBJECT_DESCRIPTOR_FLAGS_4_SLOTS,
        (ObjectDescriptorCallback)dll_99_func00_nop,
        (ObjectDescriptorCallback)dll_99_func01_nop,
        0,
        (ObjectDescriptorCallback)dll_99_func03,
    },
    0,
};
