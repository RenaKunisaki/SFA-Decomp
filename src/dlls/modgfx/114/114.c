...
ObjectDescriptor4 dll_72_funcs = {
    0,
    0,
    0,
    OBJECT_DESCRIPTOR_FLAGS_4_SLOTS,
    (ObjectDescriptorCallback)dll_72_func00_nop,
    (ObjectDescriptorCallback)dll_72_func01_nop,
    0,
    (ObjectDescriptorCallback)dll_72_func03,
};
