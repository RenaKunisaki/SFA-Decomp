...
ObjectDescriptor4WithPadding dll_74_funcs = {
    {
        0,
        0,
        0,
        OBJECT_DESCRIPTOR_FLAGS_4_SLOTS,
        (ObjectDescriptorCallback)dll_74_func00_nop,
        (ObjectDescriptorCallback)dll_74_func01_nop,
        0,
        (ObjectDescriptorCallback)dll_74_func03,
    },
    0,
};
