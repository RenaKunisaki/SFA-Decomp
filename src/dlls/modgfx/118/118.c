...
ObjectDescriptor4 dll_76_funcs = {
    0,
    0,
    0,
    OBJECT_DESCRIPTOR_FLAGS_4_SLOTS,
    (ObjectDescriptorCallback)dll_76_func00_nop,
    (ObjectDescriptorCallback)dll_76_func01_nop,
    0,
    (ObjectDescriptorCallback)dll_76_func03,
};
