...
void dll_66_func03(int sourceObj, int variant, int posSource, u32 flags)
{
    ...
    buf.entries[18].x = 0.0f;
    buf.entries[18].y = 200.0f;
    buf.entries[18].z = 0.0f;
...
u32 lbl_80313394[9] = {
    0x00000000, 0x00000000,         0x00000000, 0x00030000, (u32)dll_66_func00_nop, (u32)dll_66_func01_nop,
    0x00000000, (u32)dll_66_func03, 0x00000000,
};
