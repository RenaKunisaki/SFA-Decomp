...
ObjectDescriptor4WithPadding dll_62_funcs = {
    {
        0,
        0,
        0,
        OBJECT_DESCRIPTOR_FLAGS_4_SLOTS,
        (ObjectDescriptorCallback)dll_62_func00_nop,
        (ObjectDescriptorCallback)dll_62_func01_nop,
        0,
        (ObjectDescriptorCallback)dll_62_func03,
    },
    0,
};
