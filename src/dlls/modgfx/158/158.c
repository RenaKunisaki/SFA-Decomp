...
ObjectDescriptor4 dll_9E_funcs = {
    0,
    0,
    0,
    OBJECT_DESCRIPTOR_FLAGS_4_SLOTS,
    (ObjectDescriptorCallback)dll_9E_func00_nop,
    (ObjectDescriptorCallback)dll_9E_func01_nop,
    0,
    (ObjectDescriptorCallback)dll_9E_func03,
};
