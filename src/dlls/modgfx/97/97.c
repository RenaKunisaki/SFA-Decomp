...
ObjectDescriptor4 dll_61_funcs = {
    0,
    0,
    0,
    OBJECT_DESCRIPTOR_FLAGS_4_SLOTS,
    (ObjectDescriptorCallback)dll_61_func00_nop,
    (ObjectDescriptorCallback)dll_61_func01_nop,
    0,
    (ObjectDescriptorCallback)dll_61_func03,
};
