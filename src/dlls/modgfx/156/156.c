...
ObjectDescriptor4WithPadding dll_9C_funcs = {
    {
        0,
        0,
        0,
        OBJECT_DESCRIPTOR_FLAGS_4_SLOTS,
        (ObjectDescriptorCallback)dll_9C_func00_nop,
        (ObjectDescriptorCallback)dll_9C_func01_nop,
        0,
        (ObjectDescriptorCallback)dll_9C_func03,
    },
    0,
};
