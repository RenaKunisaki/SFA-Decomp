...
typedef struct Dll65EffectVertex {
    s16 positionX;
    s16 positionY;
    s16 positionZ;
    s16 texCoordS;
...
STATIC_ASSERT(offsetof(Dll65EffectVertex, positionX) == 0x00);
STATIC_ASSERT(offsetof(Dll65EffectVertex, positionY) == 0x02);
STATIC_ASSERT(offsetof(Dll65EffectVertex, positionZ) == 0x04);
STATIC_ASSERT(offsetof(Dll65EffectVertex, texCoordS) == 0x06);
STATIC_ASSERT(offsetof(Dll65EffectVertex, texCoordT) == 0x08);
STATIC_ASSERT(sizeof(Dll65EffectVertex) == 0x0A);

typedef struct Dll65EffectResourceView {
    Dll65EffectVertex vertices[14];
    s16 colors[12][3];
