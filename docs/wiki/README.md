...
- FuelCellPlacement.offBit/onBit (`include/dlls/objects/291_fuelCell.h`) are the concrete field pair responsible for the wiki's reported fuel-cell GameBit-collision bugs.
