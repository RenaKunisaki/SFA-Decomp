...
| `0x1A` | Ice Mountain after re-race | `dlls/objects/361_IMIceMounta/IMIceMounta.c` (a shared `warpCountdown` field/comment is also templated, unreached, in `dlls/objects/364/364.c`, `dlls/objects/446/446.c`, and `DIM/dll_01BF_dimlavaball.c`) |
