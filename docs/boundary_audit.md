...
|---|---|---|
| main/light.c (801FBAC8-801FD398) | DLLs 0x21F-0x224 — VFP-lane DLL code (vfpplatform/vfpdoorswitch/seqpoint/vfpdraghead/vfpcoreplat symbols) | not engine light code |
