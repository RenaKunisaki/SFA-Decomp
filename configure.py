...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "dlls/objects/417/417.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/NW/dll_01A5_nwlevcontrol.c", cflags=cflags_dll_noopt_noinline),
