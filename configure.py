...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/audio/voice_prio.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            ...
            Object(NonMatching, "main/audio/voice_manage.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            Object(NonMatching, "main/audio/voice_alloc.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            ...
            Object(NonMatching, "main/gametext_measurebyid.c", cflags=cflags_dll_noopt_nocse_noinline),
            ...
            Object(NonMatching, "main/dll/dll_0069_dll69func0.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/mikaladon.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_01A9_bombplant.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/SC/dll_01BB_sctotembond.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/SB/dll_01E8_sbgalleon.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(NonMatching, "main/dll/WC/dll_0297_wctemplebri.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/LGT/dll_02AC_lgtcontrollight.c", cflags=cflags_dll_noopt_level1),
