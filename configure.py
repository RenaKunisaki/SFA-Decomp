...
config.libs = [
    ...
    DolphinLib(
        ...
        [
            ...
            Object(MatchingFor("GSAE01"), "dolphin/MSL_C/PPCEABI/bare/H/e_sqrt.c", cflags=msl_math_o0_cflags, extra_cflags=["-O0", "-opt", "peephole", "-inline", "auto", "-use_lmw_stmw", "on", *msl_math_extra], section_alignments={".sdata2": 4}),
    ...
    },
    {
        ...
        "progress_category": "game",
            ...
            Object(NonMatching, "dlls/objects/373_DFropenode/DFropenode.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "dlls/objects/523_FireFly/FireFly.c", cflags=cflags_dll_noopt_noinline),
            ...
            Object(NonMatching, "dlls/objects/679_ARWProximit/ARWProximit.c", cflags=cflags_dll_noopt_nocse),
