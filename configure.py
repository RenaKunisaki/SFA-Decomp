...
config.libs = [
    ...
    },
    {
        ...
        "progress_category": "sdk",
        "objects": [
            Object(MatchingFor("GSAE01"), "dolphin/TRK_MINNOW_DOLPHIN/mainloop.c", mw_version="GC/1.3.2"),
            ...
            Object(MatchingFor("GSAE01"), "dolphin/TRK_MINNOW_DOLPHIN/dispatch.c", mw_version="GC/1.3.2"),
            ...
            Object(MatchingFor("GSAE01"), "dolphin/TRK_MINNOW_DOLPHIN/MWTrace.c", mw_version="GC/1.2.5n", extra_cflags=["-sdata", "8", "-sdata2", "8", "-schedule", "off"]),
    ...
    DolphinLib(
        ...
        [
            ...
            Object(NonMatching, "dolphin/MSL_C/PPCEABI/bare/H/exponentialsf.c", mw_version="GC/1.1", extra_cflags=["-O3,p", "-opt", "nopeephole", "-sdata", "0"]),
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "musyx/runtime/mcmd_exec.c"),
            ...
            Object(MatchingFor("GSAE01"), "musyx/runtime/voice_id.c", extra_cflags=["-O2"]),
            Object(NonMatching, "musyx/runtime/voice.c"),
            Object(MatchingFor("GSAE01"), "musyx/runtime/voice_conv.c"),
            ...
            Object(MatchingFor("GSAE01"), "musyx/runtime/hw_sample.c", mw_version="GC/2.0"),
            Object(MatchingFor("GSAE01"), "musyx/runtime/hw_voice_start.c"),
            Object(MatchingFor("GSAE01"), "musyx/runtime/hw_keyoff.c", mw_version="GC/2.0"),
    ...
    },
    {
        ...
        "progress_category": "game",
            ...
            Object(NonMatching, "dlls/engine/1_camcontrol/camcontrol.c", cflags=cflags_dll_noopt, section_alignments={".data": 4}),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/12/12.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/13/13.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/14/14.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "dlls/engine/19/19.c", cflags=cflags_dll_noopt_noautoinline, section_alignments={".data": 4}),
            ...
            Object(NonMatching, "dlls/engine/22/22.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/26/26.c", cflags=cflags_dll_noopt, section_alignments={".data": 4}),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/29/29.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/34/34.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/35/35.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/36/36.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/37/37.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/38/38.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/39/39.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/40/40.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/41/41.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/42/42.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/43/43.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/engine/44/44.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "dlls/engine/54/54.c", cflags=cflags_dll_noopt, mw_version="GC/1.3"),
            Object(NonMatching, "dlls/engine/55/55.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "dlls/modgfx/92/92.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/modgfx/93/93.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "dlls/modgfx/102/102.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/modgfx/103/103.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/modgfx/104/104.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/modgfx/105/105.c", cflags=cflags_dll_noopt_noprop),
            Object(MatchingFor("GSAE01"), "dlls/modgfx/106/106.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/200_DepthOfFieldPoint/DepthOfFieldPoint.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "dlls/objects/226/226.c", cflags=cflags_dll_noopt, section_alignments={".data": 4}),
            Object(MatchingFor("GSAE01"), "dlls/objects/227/227.c", cflags=cflags_dll_noopt, section_alignments={".data": 4}),
            ...
            Object(NonMatching, "dlls/objects/279_AppleOnTree/AppleOnTree.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "dlls/objects/601_SB_Cloudrun/SB_Cloudrun.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/tex_dolphin.c", cflags=cflags_dll_noopt_noautoinline_deferred, section_alignments={".data": 4}),
            ...
            Object(NonMatching, "track/intersect.c", cflags=cflags_dll_noopt_noautoinline, section_alignments={".data": 4}),
            ...
            Object(Matching, "n_attractmode.c", cflags=cflags_dll_noopt),

            # main/thp
            Object(NonMatching, "main/thp/dll_3b.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/thp/n_options.c", cflags=cflags_dll_noopt),
