...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_80138b60.c", cflags=cflags_dll_noopt_nostrength, mw_version="GC/1.3"),
            Object(
                MatchingFor("GSAE01"),
                "main/dll/skeetla.c",
            ...
            Object(NonMatching, "main/dll/SB/dll_01E8_sbgalleon.c", cflags=cflags_dll_noopt_noloopinv, mw_version="GC/1.3"),
            ...
            Object(NonMatching, "main/worldplanet_lighting.c", cflags=cflags_dll_nosched, mw_version="GC/1.3"),
            ...
            Object(NonMatching, "main/dll/ARW/dll_02A6_arwsquadron.c", cflags=cflags_dll_noopt_noautoinline),
