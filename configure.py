...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(
                MatchingFor("GSAE01"), "musyx/runtime/aram_init.c",
    ...
    },
    {
        ...
        "progress_category": "game",
            ...
            Object(
                NonMatching, "dlls/engine/11/11.c", cflags=cflags_dll_noopt_noautoinline,
            ...
            Object(
                MatchingFor("GSAE01"), "dlls/engine/26/26.c", cflags=cflags_dll_noopt,
                section_alignments={".data": 4},
            ),
            ...
            Object(
                MatchingFor("GSAE01"), "main/thp/dll_3e.c", cflags=cflags_dll_noopt,
                section_alignments={".sbss": 4},
            ),
            Object(MatchingFor("GSAE01"), "main/thp/attractmovie.c", cflags=cflags_dll_noopt),
            Object(
                MatchingFor("GSAE01"), "main/thp/picmenu.c", cflags=cflags_dll_noopt_noinline,
                section_alignments={".sdata2": 4},
            ),
