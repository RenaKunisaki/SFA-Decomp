...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/dll/NW/dll_01A1_nwmammoth.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/worldplanet.c", cflags=cflags_dll_noopt, mw_version="GC/1.3"),
            ...
            Object(NonMatching, "dlls/objects/625/625_updatemain.c", cflags=cflags_dll_noopt_nocse_nodead_nofpcontract_noautoinline),
