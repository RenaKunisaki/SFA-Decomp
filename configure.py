...
config.libs = [
    ...
    },
    {
        ...
        "progress_category": "game",
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/202/mikaladon.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(Matching, "main/objlib.c", cflags=cflags_dll_noopt_noautoinline),
