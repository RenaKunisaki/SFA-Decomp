...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(NonMatching, "main/textrender_gettext.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/WM/dll_0211_wmwallcrawler.c", cflags=cflags_dll_noopt_noloopinv_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/WM/dll_0215_wmnewcrystal.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/VF/dll_0216_vfplevelcontrol.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/VF/dll_0217_vfpobjcreator.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/VF/dll_0218_vfpminifire.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0219.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/VF/dll_021A_vfpstatueball.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/audio/snd_midictrl.c", mw_version="GC/1.2.5n", extra_cflags=["-Cpp_exceptions", "on"]),
            ...
            Object(NonMatching, "main/dll/player_die.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            Object(NonMatching, "main/dll/player_moveheights.c", cflags=[*cflags_dll_noopt_noprop, "-inline", "noauto"]),
            Object(NonMatching, "main/dll/player_animate.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            Object(NonMatching, "main/dll/player_render.c", cflags=[*cflags_dll_noopt_noprop, "-inline", "noauto"]),
            Object(NonMatching, "main/dll/player_update.c", cflags=[*cflags_dll_noopt, "-inline", "noauto"]),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0241_drakorenergy.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_0242_dbstealerworm.c", cflags=cflags_dll_noopt_noloopinv_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0243_dbholecontrol1.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_0229_dfplevelcontrol.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_022A_dfpobjcreator.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_022C_dll22c.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_022E_dfpdoorswitch.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_022D_dfpseqpoint.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_022B_dfptorch.c", cflags=cflags_dll_noopt_nocse),
            ...
            Object(NonMatching, "track/intersect_earthwalkersfx.c", cflags=cflags_dll_noopt_nocse_noautoinline),
            ...
            Object(NonMatching, "main/dll/expgfx_addtotable.c", cflags=cflags_dll_noopt_noautoinline),
            Object(NonMatching, "main/dll/expgfx_frameflags.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/dll_0052_cameramodeforcebehind.c", cflags=cflags_dll_noopt_noprop),
            ...
            Object(NonMatching, "main/dll/dll_0000_gameui.c", cflags=cflags_dll_noopt, extra_cflags=["-inline", "noauto", "-opt", "nopropagation"]),
            ...
            Object(
                MatchingFor("GSAE01"),
                "main/dll/skeetla.c",
                cflags=cflags_dll_noopt_nolifetimes_noautoinline,
                section_alignments={".data": 4},
            ),
            ...
            Object(Matching, "main/dll/staff.c"),
            Object(MatchingFor("GSAE01"), "main/dll/tumbleweedbush.c", cflags=cflags_dll_noopt_noprop),
            Object(NonMatching, "main/dll/animobjd2.c", cflags=[*cflags_base, "-opt", "nopeephole,noschedule,nocse,nopropagation,noloopinvariants,nodead"]),
            Object(Matching, "main/dll/dll_d3.c"),
            ...
            Object(
                NonMatching, "main/dll/tricky_substates.c", cflags=cflags_dll_noopt_noprop_nostrength,
                section_alignments={".data": 4},
            ),
            Object(
                NonMatching, "main/dll/dll_00C4_tricky.c", cflags=cflags_dll_noopt,
                section_alignments={".data": 4},
            ),
            ...
            Object(NonMatching, "main/dll/gcrobotpatrol.c", cflags=cflags_dll_noopt_nocse_noautoinline),
            ...
            Object(NonMatching, "main/dll/dll_00CB_dllcb.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(NonMatching, "main/dll/tumbleweedgroup.c", cflags=cflags_dll_noopt_noloopinv_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_00D3_staffAction.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00D4_skeetlawall.c", cflags=cflags_dll_noopt),
            Object(Matching, "main/dll/cfdoorlightgroup.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00D6_kaldachomme.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00D7_kaldachompspit.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00D8_pinponspike.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00D9_pollen.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00DA_pollenfragment.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00DB_mikabomb.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00DC_mikabombshadow.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_00E4_flamethrowerspe.c", cflags=cflags_dll_noopt_nocse),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_00E6_restartmarker.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00F7_dllf7.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00E8_checkpoint4.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00EA_sideload.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00EB_siderepel.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00E9_setuppoint.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_00ED_collectible.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00FF_magicgem.c", cflags=cflags_dll_noopt_noloopinv),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00EE_effectbox.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_00EF_pushable.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00F0_warppoint.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_00F1_invhit.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_00F4_doorf4.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0110_door.c", cflags=cflags_dll_noopt_noloopinv),
            Object(MatchingFor("GSAE01"), "main/dll/MMP/dll_010F_mmpbridge.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0111_doorlock.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0112_seqobject.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0113_seqobj2.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/IM/dll_0114_immultiseq.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0115_dll115.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/WM/dll_0116_wmcolumn.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_0117_appleontree.c", cflags=cflags_dll_noopt_noautoinline),
            Object(NonMatching, "main/dll/dll_0117_appleontree_knockloose.c", cflags=cflags_dll_noopt_nolifetimes_noautoinline),
            Object(NonMatching, "main/dll/dll_0117_appleontree_update.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00FC_babycloudrunner.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00FD.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00FE_magicplant.c", cflags=cflags_dll_noopt_nocse_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0100_trickywarp.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0101_trickyguard.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0102_staypoint.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0118_duster.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0103_curvefish.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_801814d0.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_0104_smallbasket.c", cflags=cflags_dll_noopt_noprop),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0105_largecrate.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_0106_scarab.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0107_unused.c", cflags=cflags_dll_noopt_nocse_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0108_endobject.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_010D_portalspelldoor.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_010C_lanternfirefly.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_010B_fireflylantern.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00E7_flammablevine.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0109_unk.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_010A_fallladders.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0119_coldwatercontrol.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_00EC_infopoint.c", cflags=cflags_dll_noopt),
            Object(Matching, "main/dll/dll_011A_decoration11a.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_011B_landedarwing.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/staffactivatedgroup.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_011D_treasurechest.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_011E_magiccavebottom.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_011F_magiccavetop.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0120_trickyguardspot.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0121_infotext.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0122_cctestinfot.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0124_deathgas.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0123_fuelcell.c", cflags=cflags_dll_noopt_noloopinv),
            Object(MatchingFor("GSAE01"), "main/dll/dll_010E_deathseq.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0127_dll127.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0129_campfire.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DR/dll_0128_kttorch.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/CF/dll_012A_cfcrate.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_012B_fxemit.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0130_areafxemit.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_012D_lfxemitter.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/warppad.c", cflags=cflags_dll_noopt_nocse),
            Object(MatchingFor("GSAE01"), "main/dll/dll_012C_transporter.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(Matching, "main/dll/dll_0139_hitanimator.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_013A_visanimator.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_013D_explodeanimator.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_013E_dimbossicesmash.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_013F_texframeanimator.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0140_fogcontrol.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0141_lightning.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0132_waterfallspray.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/dll_014C_babycloudrunner.c", cflags=cflags_dll_noopt_nocse_noinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0150_gcrobotlightbea.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0157_spiritdoorspirit.c", cflags=cflags_dll_noopt_nocse),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0158_gunpowderbarrel.c", cflags=cflags_dll_noopt_noinline),
            Object(Matching, "main/dll/dll_0159_blasted.c", cflags=cflags_dll_noopt_noloopinv_noinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0167_spiritdoorlock.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/MMP/dll_0180_mmpasteroidre.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/MMP/dll_0182_mmpmoonrock.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/MMP/dll_0181_mmptrenchfx.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/MMP/dll_0183_mmpgyservent.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0184_animsharpclaw.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_025B_msplantings.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0185_ccgasvent.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0186_ccgasventcontrol.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0187_ccqueen.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0188_cclightfoot.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0189_ccsharpclawpad.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_018A_ccpedstal.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_018B_cclevcontrol.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_801ac01c.c", cflags=cflags_dll_nosched),
            Object(MatchingFor("GSAE01"), "main/dll/IM/dll_0169_imicemountain.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_016A_crrockfall.c", cflags=cflags_dll_noopt_noprop_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_016B_magiclight.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/dll_016C_dll16c.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/IM/dll_016D_imicepillar.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/IM/dll_016E_imanimspacecraft.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/IM/dll_016F_imspacethruster.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0172_linkblevcontrol.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0173_linklevcontrol.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01BE_dimlava.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01BF_dimlavaball.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01C0_dimlogfire.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01C1_dimsnowball.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/DIM/dll_01C7_dimlavasmash.c", cflags=cflags_dll_noopt_noprop_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01C8_dimbridgecogmai.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01C9_dimdismountpoint.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DIM/dll_01CA_dimexplosion.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01CB_dimwooddoor2.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01CE_dll1ce.c", cflags=cflags_dll_noopt_nostrength),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01CC_dimmagicbridge.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01CD_dimlevelcontrol.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01CF_dll1cf.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01D0_dimtricky.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01D1_dimtruthhornice.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01D5_dim2conveyor.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01D6_dll1d6.c", cflags=cflags_dll_noopt_nocse),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01D7_dim2snowball.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01D8_dim2pathgenerator.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01DA_dll1da.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01DB_dll1db.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01DC_dim2icefloe.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DIM/dll_01DD_dim2icicle.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01DE_dim2lavacontrol.c", cflags=cflags_dll_noopt_nocse),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01DF_dll1df.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_801b9ecc.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DIM/dim2lift.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01E2_dimbosstonsil.c", cflags=cflags_dll_noopt_noprop),
            Object(NonMatching, "main/dll/DIM/dimgut2group.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01E5_dimbossspit.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01E4_magicmaker.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01E6_dimbosscrackpar.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DIM/dll_01E7_dimbossfire.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/CC/dll_0174_ccriverflow.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_0179_dfshobjcreator.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_017B_dfshlaserbeam.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_018C_mmshshrine.c", cflags=cflags_dll_noopt_nolifetimes_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_018D_mmshscales.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_018E_mmshwaterspike.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_018F_ecshshrine.c", cflags=cflags_dll_noopt_nostrength),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0191_ecshcreator.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0199_dll199.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_019A_dll19a.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/NW/nwmammothgroup.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/NW/dll_01A2_nwtricky.c", cflags=cflags_dll_noopt_noloopinv),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_01A9_bombplant.c", cflags=cflags_dll_noopt_noautoinline),
            Object(Matching, "main/dll/dll_01AA_bombplantspore.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/SC/dll_01B7_scmusictree.c", cflags=cflags_dll_noopt_nocse_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/SC/dll_01B8_sctotempole.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/SC/dll_01BB_sctotembond.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/SB/dll_01E8_sbgalleon.c", cflags=cflags_dll_noopt_noloopinv, mw_version="GC/1.3"),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/SB/dll_01EF_sbcloudball.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/SB/dll_01F0_sbkytecage.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/SB/dll_01F2_sbcagekyte.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/SB/dll_01F1_sbseqdoor.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/SB/dll_01F3_sbminifire.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01F5_shipbattle.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01F4_lamp.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_01F6_flag.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/laserturretgroup.c", cflags=cflags_dll_noopt_noautoinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/dll_0200_dll200.c", cflags=cflags_dll_noopt_nostrength_noinline),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/WM/dll_0209_wmlevelcontrol.c", cflags=cflags_dll_noopt, mw_version="GC/1.3"),
            ...
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_0233_dfpstatue1.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_0234_dfpperchsw.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DF/dll_0235_dfptargetblock.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/CF/laser.c", cflags=cflags_dll_noopt),
            ...
            Object(MatchingFor("GSAE01"), "main/platform1.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dfplightni.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dfppowersl.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0245_dummy245.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0246_dummy246.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0244_dummy244.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0247_dummy247.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0248_dummy248.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_024A_dummy24a.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_024B_dummy24b.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/worldasteroids.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/worldplanet_lighting.c", cflags=cflags_dll_nosched, mw_version="GC/1.3"),
            ...
            Object(MatchingFor("GSAE01"), "main/proximitymine_update.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DR/dll_024F_ktrexlevel.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DR/dll_0250_ktrex.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/DR/dll_0251_ktrexfloorswitch.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DR/dll_0252_ktlazerwall.c", cflags=cflags_dll_noopt_noautoinline),
            Object(MatchingFor("GSAE01"), "main/dll/DR/dll_0253_ktlazerlight.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/DR/dll_0254_ktfallingrocks.c", cflags=cflags_dll_noopt),
            Object(NonMatching, "main/dll/DR/dll_0261_drlasercannon.c", cflags=cflags_dll_noopt_noinline),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0262_drakormissile.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "main/dll/dll_0263_gmmazewell.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/ARW/dll_02A7_arwproximit.c", cflags=cflags_dll_noopt),
            ...
            Object(NonMatching, "main/dll/LGT/dll_02AB_lgtprojectedlight.c", cflags=cflags_dll_noopt_nocse),
