...
config.libs = [
    ...
    },
    {
        ...
        "progress_category": "game",
            ...
            Object(NonMatching, "dlls/engine/1_camcontrol/camcontrol.c", section_alignments={".data": 4}),
            ...
            Object(NonMatching, "dlls/engine/22/22.c"),
            Object(NonMatching, "dlls/engine/23/23.c", cflags=cflags_dll_noopt_noautoinline),
            Object(NonMatching, "dlls/engine/24/24.c"),
            Object(NonMatching, "dlls/engine/25/25.c"),
            Object(MatchingFor("GSAE01"), "dlls/engine/26/26.c", section_alignments={".data": 4}),
            ...
            Object(MatchingFor("GSAE01"), "dlls/engine/48/48.c", cflags=cflags_base),
            ...
            Object(NonMatching, "dlls/engine/54/54.c", mw_version="GC/1.3"),
            Object(NonMatching, "dlls/engine/55/55.c"),
            ...
            Object(NonMatching, "dlls/engine/65/65.c"),
            Object(NonMatching, "dlls/engine/66/66.c", cflags=cflags_dll_noopt_noautoinline),
            Object(NonMatching, "dlls/engine/67/67.c"),
            ...
            Object(NonMatching, "dlls/objects/226/226.c", section_alignments={".data": 4}),
            ...
            Object(NonMatching, "dlls/objects/251/251.c"),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/566_DFP_LaserBe/DFP_LaserBe.c"),
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/569/569.c"),
