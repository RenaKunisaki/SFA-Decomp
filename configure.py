...
config.libs = [
    ...
    ),
    {
        ...
        "objects": [
            ...
            Object(MatchingFor("GSAE01"), "dlls/objects/211/backpack.c", cflags=cflags_dll_noopt),
            Object(MatchingFor("GSAE01"), "dlls/objects/211/landedArwing.c", cflags=cflags_dll_noopt),
