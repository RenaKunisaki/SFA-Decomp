...
#define DIMBOSSTONSIL_CONTROL_MODE_OFFSET       0x274
...
typedef struct DIMbosstonsilState
{
    ...
    s16 field270;
    u8 pad272[DIMBOSSTONSIL_CONTROL_MODE_OFFSET - 0x272];
    s16 controlMode;
...
STATIC_ASSERT(offsetof(DIMbosstonsilState, controlMode) == DIMBOSSTONSIL_CONTROL_MODE_OFFSET);
...
void DIMbosstonsil_init(GameObject* obj, u32 param_2, int isAltVariant);
