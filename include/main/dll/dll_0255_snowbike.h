...
typedef struct SnowBikeSwingFlags
{
...
/* The SnowBike state block as the swing/attachment helpers view it (the `state` byte base passed
 * to SnowBike_UpdateSwingBlend / SnowBike_UpdateAttachedPosition). Field
 * widths verified against the target asm; gaps are spelled as pads. */
typedef struct SnowBikeSwingState
{
    u8 pad00[0x0C];
    ...
    SnowBikeSwingFlags flags; /* 0x428 */
