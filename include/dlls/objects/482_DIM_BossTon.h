...
STATIC_ASSERT(offsetof(DIMbosstonsilState, substate) == 0x270);
STATIC_ASSERT(offsetof(DIMbosstonsilState, controlMode) == 0x274);
STATIC_ASSERT(offsetof(DIMbosstonsilState, moveJustStartedA) == 0x27A);
STATIC_ASSERT(offsetof(DIMbosstonsilState, moveJustStartedB) == 0x27B);
STATIC_ASSERT(offsetof(DIMbosstonsilState, moveSpeed) == 0x2A0);
STATIC_ASSERT(offsetof(DIMbosstonsilState, targetObj) == 0x2D0);
STATIC_ASSERT(offsetof(DIMbosstonsilState, moveDone) == 0x346);
STATIC_ASSERT(offsetof(DIMbosstonsilState, hasTarget) == 0x349);
...
STATIC_ASSERT(offsetof(DIMbosstonsilState, gameBitB) == 0x3F4);
STATIC_ASSERT(offsetof(DIMbosstonsilState, gameBitC) == 0x3F6);
STATIC_ASSERT(offsetof(DIMbosstonsilState, flags400) == 0x400);
STATIC_ASSERT(offsetof(DIMbosstonsilState, subMode) == 0x405);
